...
module.exports = class ProfileLike extends Sequelize.Model {
    static init(sequelize) {
        return super.init(
            ...
            },
            {
                ...
                modelName: "ProfileLike", // 프로젝트에서 사용하는 모델의 이름
                tableName: "profileLikes", // 실제 데이터베이스의 테이블 이름
    ...
    static associate(db) {
        db.User.hasMany(db.ProfileLike, {
            foreignKey: {name: "liker_id", type: DataTypes.STRING},
            sourceKey: "id"
        });
        db.Profile.hasMany(db.ProfileLike, {
