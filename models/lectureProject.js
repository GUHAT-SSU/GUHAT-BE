...
module.exports = class LectureProject extends Sequelize.Model {
    static init(sequelize) {
        return super.init(
            ...
            },
            {
                ...
                modelName: "LectureProject", // 프로젝트에서 사용하는 모델의 이름
                tableName: "lectureProjects", // 실제 데이터베이스의 테이블 이름
    ...
    static associate(db) {
        db.LecturePost.hasOne(db.LectureProject, {
            foreignKey: {name: "lecturePost_id"},
            sourceKey: "id",
        });
        db.LecturePost.hasMany(db.LectureProject, {
